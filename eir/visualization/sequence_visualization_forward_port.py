...
# This is a temporary, partial forward port of the text plot module from shap.
# The current stable released shap version (v0.39.0) does not support returning
# from the text(...) function below, only displaying
# This module is from a newer commit, however if we install from a commit we
# cannot upload to pipy as they do not allow that for security reasons
# TODO: Remove this module when shap gets updated
