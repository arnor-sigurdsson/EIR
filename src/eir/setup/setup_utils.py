...
def get_unsupported_hf_models() -> dict:
    unsupported = {
        ...
        "aria": "Too large for testing.",
        "aria_text": "Too large for testing.",
        "aya_vision": "Not strictly sequence model.",
        "autoformer": "Not strictly sequence model.",
        "bark": "Not strictly sequence model.",
        "bamba": "Too large for testing.",
        ...
        "blip_2_qformer": "Not strictly sequence model.",
        "bridgetower": "Not strictly sequence model.",
        "bros": "Not strictly sequence model.",
        "camembert": "Not strictly sequence model.",
        ...
        "clip_text_model": "CLIPTextModel.forward() got an unexpected keyword argument"
        " 'inputs_embeds'",
        ...
        "csm": "Not strictly sequence model.",
        "cvt": "Not strictly sequence model.",
        "d_fine": "Not strictly sequence model.",
        "dab-detr": "Not strictly sequence model.",
        "dac": "Not strictly sequence model.",
        ...
        "dia": "Not strictly sequence model.",
        "dinov2": "Not strictly sequence model.",
        "dinov2_with_registers": "Not strictly sequence model.",
        "detr": "Not strictly sequence model.",
        "depth_pro": "Not strictly sequence model.",
        "donut-swin": "Not strictly sequence model.",
        "dots1": "Missing parameters in config.",
        "dpr": "Not strictly sequence model.",
        "dpt": "Not strictly sequence model.",
        "emu3": "Not strictly sequence model.",
        ...
        "gemma3n_vision": "Not strictly sequence model.",
        "gemma3n_audio": "Not strictly sequence model.",
        "gemma3n_text": "activation_sparsity_pattern must have an explicit "
        "activation...",
        "glm": "The size of tensor a (2) must match the size of tensor b (64) "
        "at non-singleton dimension 3",
        "glpn": "Not strictly sequence model.",
        "git": "Not strictly sequence model.",
        "glm4v": "Not strictly sequence model.",
        "glm4v_text": "Not strictly sequence model.",
        "granite": "Very large model, not suitable for testing.",
        "granitemoe": "Very large model, not suitable for testing.",
        "granitemoehybrid": "Setup error.",
        ...
        "gptj": "Very large model, not suitable for testing.",
        "gpt2": "Very large model, not suitable for testing.",
        "gpt-sw3": "Very large model, not suitable for testing.",
        "gpt_bigcode": "Very large model, not suitable for testing.",
        ...
        "hgnet_v2": "Not strictly sequence model.",
        "helium": "Shape mismatch error.",
        "ibert": "Very large model, not suitable for testing.",
        "informer": "Not strictly sequence model.",
        "imagegpt": "Not strictly sequence model.",
        "instructblip": "Not strictly sequence model.",
        "instructblipvideo": "Not strictly sequence model.",
        "idefics": "Not strictly sequence model.",
        "idefics2": "Not strictly sequence model.",
        "idefics3": "Very large model, not suitable for testing.",
        "idefics3_vision": "Not strictly sequence model.",
        "ijepa": "Not strictly sequence model.",
        ...
        "kyutai_speech_to_text": "Not strictly sequence model.",
        ...
        "lightglue": "Not strictly sequence model.",
        ...
        "mimi": "Not strictly sequence model.",
        "mlcd": "Not strictly sequence model.",
        ...
        "moonshine": "Not strictly sequence model.",
        ...
        "omdet-turbo": "Not strictly sequence model.",
        "open-llama": "'OpenLlamaAttention' object has no attribute 'rope_theta'.",
        "ocr2": "Not strictly sequence model.",
        "got_ocr2": "Not strictly sequence model.",
        ...
        "rt_detr_v2": "Not strictly sequence model.",
        "sam": "Not strictly sequence model.",
        "sam_hq": "Not strictly sequence model.",
        "sam_vision_model": "Not strictly sequence model.",
        "sam_hq_vision_model": "Not strictly sequence model.",
        ...
        "siglip2": "Not strictly sequence model.",
        "smolvlm": "Not strictly sequence model.",
        "smolvlm_vision": "Not strictly sequence model.",
        "speech_to_text": "Not strictly sequence model.",
        "speecht5": "Not strictly sequence model.",
        "superglue": "Not strictly sequence model.",
        ...
        "timesfm": "Not strictly sequence model.",
        "textnet": "Not strictly sequence model.",
        "timesformer": "Not strictly sequence model.",
        "timm_backbone": "Not strictly sequence model.",
        "timm_wrapper": "Not strictly sequence model.",
        ...
        "pixtral": "Not strictly sequence model.",
        "phi4_multimodal": "Not strictly sequence model.",
        ...
        "qwen2_audio_encoder": "Not strictly sequence model.",
        "qwen2_vl": "Not strictly sequence model.",
        "qwen2_5_vl": "Not strictly sequence model.",
        "qwen2_vl_text": "Not strictly sequence model.",
        "qwen2_5_vl_text": "Not strictly sequence model.",
        ...
        "vjepa2": "Not strictly sequence model.",
        ...
        "zamba": "Random None is not iterable error.",
        "zamba2": "Random None is not iterable error.",
    }
