...
from eir.train_utils.ignite_port.events import CallableEventWithFilter, Events
from eir.train_utils.ignite_port.utils import _CollectionItem, _tree_apply2, _tree_map

if TYPE_CHECKING:
    from eir.train_utils.ignite_port.metrics.metrics_lambda import MetricsLambda
